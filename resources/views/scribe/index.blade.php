    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="product">
                    <a href="#product">Product</a>
                                ...
                                <a href="#product-POSTapi-products">POST api/products</a>
                            </li>
                                ...
                                <a href="#product-PUTapi-products--id-">PUT api/products/{id}</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="order">Order</h1>
                                ...
                                <h2 id="order-GETapi-orders">GET api/orders</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="order-POSTapi-orders">POST api/orders</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="items.0.qty"                data-endpoint="POSTapi-orders"
               value="22"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>22</code></p>
                    ...
                    <h2 id="order-GETapi-orders--id-">GET api/orders/{id}</h2>
...
<p>The ID of the order. Example: <code>architecto</code></p>
                    ...
                    <h2 id="order-PUTapi-orders--id-">PUT api/orders/{id}</h2>
...
<p>The ID of the order. Example: <code>architecto</code></p>
                    ...
                    <h2 id="order-DELETEapi-orders--id-">DELETE api/orders/{id}</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="product-POSTapi-products">POST api/products</h2>
...
<p>Must be at least 0. Example: <code>39</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>vat_rate</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="vat_rate"                data-endpoint="POSTapi-products"
               value="0"
               data-component="body">
    <br>
<p>Must be between 0 and 23. Example: <code>0</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>The ID of the product. Example: <code>architecto</code></p>
                    ...
                    <h2 id="product-PUTapi-products--id-">PUT api/products/{id}</h2>
